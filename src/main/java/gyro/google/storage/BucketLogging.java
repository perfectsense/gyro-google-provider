 ...
 */
public class BucketLogging extends Diffable implements Copyable<BucketInfo.Logging> {
    ...
    @Override
    public void copyFrom(BucketInfo.Logging model) {
    ...
    public BucketInfo.Logging toBucketLogging() {
