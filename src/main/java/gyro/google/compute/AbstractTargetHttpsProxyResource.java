...
public abstract class AbstractTargetHttpsProxyResource extends ComputeResource implements Copyable<TargetHttpsProxy> {
    ...
    /**
     * The name of the target proxy. Must be 1-63 characters long, and the first character must be a lowercase letter. All other characters must be a lowercase letter, digit, or ``-``, except the last character, which cannot be a ``-``.
     */
    @Required
