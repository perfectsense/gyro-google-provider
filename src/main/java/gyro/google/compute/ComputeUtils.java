...
public final class ComputeUtils {
    ...
    public static void waitForCompletion(Compute compute, Operation operation, String projectId) {
        waitForCompletion(compute, operation, projectId, 0, null);
    }
                ...
                if (zone != null) {
                    ...
                    if (region != null) {
                        ...
                        Compute.RegionOperations.Get get = compute.regionOperations()
                            .get(projectId, region, operation.getName());
                        response = get.execute();
                    } else {
                        Compute.GlobalOperations.Get get = compute.globalOperations()
                            .get(projectId, operation.getName());
                        response = get.execute();
                    }
                }
