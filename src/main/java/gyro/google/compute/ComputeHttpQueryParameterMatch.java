...
import com.google.api.services.compute.model.HttpQueryParameterMatch;
import gyro.core.resource.Diffable;
import gyro.google.Copyable;

public class ComputeHttpQueryParameterMatch extends Diffable implements Copyable<HttpQueryParameterMatch> {
    ...
    @Override
    public void copyFrom(HttpQueryParameterMatch model) {
