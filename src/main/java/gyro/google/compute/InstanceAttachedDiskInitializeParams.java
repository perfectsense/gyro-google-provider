...
public class InstanceAttachedDiskInitializeParams extends Diffable implements Copyable<AttachedDiskInitializeParams> {
    ...
    public void copyFrom(AttachedDiskInitializeParams model) {
        ...
        if (model.hasDiskType()) {
            setDiskType(model.getDiskType());
        }

        if (model.hasSourceImageEncryptionKey()) {
        ...
        if (model.hasSourceSnapshotEncryptionKey()) {
        ...
        setResourcePolicy(model.getResourcePoliciesList().stream()
            .map(policy -> findById(ResourcePolicyResource.class, policy)).collect(Collectors.toList()));
    }

    public AttachedDiskInitializeParams copyTo() {
        AttachedDiskInitializeParams.Builder builder = AttachedDiskInitializeParams.newBuilder();
        ...
        if (getSourceImage() != null) {
            builder.setSourceImage(getSourceImage());
        }
        ...
        if (Boolean.FALSE.equals(getAutoGenerateDiskName())) {
            builder.setDiskName(getDiskName());
        }
        ...
        if (getSourceSnapshotEncryptionKey() != null) {
            builder.setSourceSnapshotEncryptionKey(getSourceSnapshotEncryptionKey() != null
                ? getSourceSnapshotEncryptionKey().toCustomerEncryptionKey() : null);
        }
