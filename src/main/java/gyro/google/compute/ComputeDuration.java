...
import com.google.api.services.compute.model.Duration;
import gyro.core.resource.Diffable;
import gyro.google.Copyable;

public class ComputeDuration extends Diffable implements Copyable<Duration> {
    ...
    @Override
    public void copyFrom(Duration model) {
